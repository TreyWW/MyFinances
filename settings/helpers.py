...
EMAIL_SERVICE: str = "SES" if ARE_AWS_EMAILS_ENABLED else "SendGrid" if EMAIL_SERVER_ENABLED else None
ARE_EMAILS_ENABLED: bool = True if EMAIL_SERVICE else False
