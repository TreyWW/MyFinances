...
AWS_S3_VERITY = True
AWS_ENABLED = (
    True if os.environ.get("AWS_ENABLED", "").lower() == "true" else False
)
...
AWS_TEXTRACT_ENABLED = AWS_TEXTRACT_ENABLED and AWS_TEXTRACT_ACCESS_KEY_ID and AWS_TEXTRACT_SECRET_ACCESS_KEY
