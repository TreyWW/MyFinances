...
class UserSettingsTeamsDashboardViewTestCase(ViewTestCase):
    def test_teams_view_302_for_non_authenticated_users(self):
        response = self.client.get(reverse("core:teams:dashboard"))
    ...
    def test_teams_view_matches_with_urls_view(self):
        ...
        self.assertEqual("core.views.settings.teams.teams_dashboard_handler", func_name)
        self.assertEqual(path, reverse("core:teams:dashboard"))
