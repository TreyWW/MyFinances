...
from backend.webhooks.stripe.webhook_listener import stripe_listener_webhook_endpoint
...
urlpatterns = [
    ...
    path("payments/stripe/", stripe_listener_webhook_endpoint, name="stripe_webhook"),
]
