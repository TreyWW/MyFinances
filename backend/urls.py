...
from backend.views.core import other, passwords, api, profile
...
urlpatterns = [
                  ...
                  path('dashboard/profile', profile.view.view_profile, name='profile'),
                  path('dashboard/profile/change_password', profile.view.change_password, name='profile change_password'),
