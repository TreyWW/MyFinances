...
from backend.decorators import feature_flag_check_multi, FlagItem
from backend.models import Invoice


@feature_flag_check_multi([FlagItem("isInvoiceSchedulingEnabled", True), FlagItem("areInvoiceRemindersEnabled", True)])
