...
def add_service(request: HttpRequest):
    ...
    list_of_current_rows = [row for row in zip(list_hours, list_service_name, list_price_per_hour)]
    ...
    return render(request, 'core/pages/invoices/create/_services_table_body.html', context)
