...
from .views.refetch_subscription_statuses import refetch_subscriptions_endpoint
...
urlpatterns = [
    ...
    path("api/billing/stripe/refetch_subscriptions/", refetch_subscriptions_endpoint, name="refetch_subscriptions"),
